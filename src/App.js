...
function App() {
  return (
    <div className="App">
      ...
      <img src='/images/react-logo.svg' className="atom1" alt="logo" />
      <img src='/images/react-logo.svg' className="atom2" alt="logo" />
      <img src='/images/react-logo.svg' className="atom3" alt="logo" />
      <img src='/images/react-logo.svg' className="atom4" alt="logo" />
        <div className="Top">
          <img src='/images/ironhack-logo.svg' className="App-logo" alt="logo" />
          <img src='/images/menu-top.svg' className="menutop" alt="logo" />
        </div>
        <h1>
